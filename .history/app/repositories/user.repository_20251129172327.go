...
// COMMAND: Cari user berdasarkan username atau email
func (r *UserRepository) FindByUsernameOrEmail(ctx context.Context, input string) (*models.User, error) {
    query := `
    ...
    row := r.DB.QueryRow(ctx, query, input)
