...
func main() {
	...
	users := []UserSeed{
		{"admin", "Administrator Kampus", "admin@kampus.ac.id", roles["admin"], "Admin!123"},

		{"dosenjoko", "Joko Setiawan", "joko@kampus.ac.id", roles["dosen"], "DosenJoko#1"},
		{"dosenwati", "Wati Lestari", "wati@kampus.ac.id", roles["dosen"], "DosenWati#1"},
